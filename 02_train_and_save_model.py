...
def load_geocoded_data():
    """Loads geocoded restaurant and customer data."""
    try:
...
def generate_order_data(df_restaurants, df_customers, n_orders=500):
    """Generates a dataset using traffic-forecasted travel times."""
    final_data = []
    print(f"\n--- Generating {n_orders} orders with traffic-forecasted data... ---")
    ...
    for i in range(n_orders):
        ...
        #Generating a random future timestamp for training ---
        ...
        day_of_week = future_dt.weekday() # 0=Monday, 6=Sunday
